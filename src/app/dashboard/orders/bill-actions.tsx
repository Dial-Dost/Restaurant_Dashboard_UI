...
export function BillActions({
  ...
  // H6 / R2 item 1 — the name and GSTIN printed on this table's bill. The dialog
  // is shared with the table preview and Accounting's past bills, so it keeps
  // its own open state rather than joining the `dialog` switch below.
